...
import { FormPreviousLink, Send } from 'grommet-icons';
    ...
    return (
        <main className="min-h-screen bg-[#1a1a1a] text-white relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 py-20">
                <Link href="/productos" className="inline-flex items-center text-gray-400 hover:text-white mb-8 transition-colors">
                    <FormPreviousLink className="mr-2" />
                    Volver a Productos
                </Link>
                ...
                <div className="flex flex-col md:flex-row gap-12">
                    ...
                    <div className="md:w-1/3 space-y-6">
                        ...
                        <div className="bg-[#2a2a2a]/50 p-6 rounded-xl border border-gray-700/50 mt-8">
                            <h3 className="font-semibold text-white mb-2">¿Qué incluye la cotización?</h3>
                            <ul className="space-y-3 text-sm text-gray-400">
                                <li className="flex items-start gap-2">
                                    <span className="text-green-400">✓</span> Desglose de hardware y especificaciones
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-green-400">✓</span> Tiempos estimados de entrega
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-green-400">✓</span> Opciones de garantía y soporte
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-green-400">✓</span> Plan de implementación on-premise
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="md:w-2/3">
                        <form onSubmit={handleSubmit} className="bg-[#2a2a2a] p-8 rounded-2xl border border-gray-700 shadow-2xl space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-[#1a1a1a] border border-gray-600 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all placeholder-gray-600"
                                        placeholder="Juan Pérez"
                                    />
                                </div>
                                <div className="space-y-2">
                                    <label htmlFor="company" className="block text-sm font-medium text-gray-300">Empresa / Organización</label>
                                    <input
                                        type="text"
                                        id="company"
                                        name="company"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <label htmlFor="email" className="block text-sm font-medium text-gray-300">Correo Corporativo</label>
                                    <input
                                        type="email"
                                        id="email"
                                        name="email"
                            ...
                            <div className="space-y-2">
                                <label htmlFor="model" className="block text-sm font-medium text-gray-300">Modelo de Interés</label>
                                <div className="relative">
                                    <select
                                        ...
                                        onChange={handleChange}
                                        className="w-full bg-[#1a1a1a] border border-gray-600 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none appearance-none transition-all"
                                    >
                            ...
                            <div className="space-y-2">
                                <label htmlFor="message" className="block text-sm font-medium text-gray-300">Detalles Adicionales o Dudas</label>
                                <textarea
                                    id="message"
                                    name="message"
                                    rows={4}
                            ...
                            <Button
                                type="submit"
                                label={isSubmitting ? "Enviando..." : "Solicitar Cotización"}
